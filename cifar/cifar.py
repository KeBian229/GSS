...
from util import cal_model_flops
...
def main():
    ...
    if args.dataset == 'FashionMNIST':
        ...
        test_data = datasets.FashionMNIST(root="./data/FashionMNIST",  # 数据路径
    ...
    if args.arch.startswith('resnext'):
        ...
        model = t_models.__dict__[args.arch]()
    ...
    if args.evaluate:
        print('\nEvaluation only')
        test_loss, test_acc, prec5 = test(testloader, model, criterion, start_epoch, use_cuda)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        test_loss, test_acc, prec5 = test(testloader, model, criterion, epoch, use_cuda)
    ...
    print('Best acc:')
    print(best_acc, best_acc5)
    
    input = [1, 3, 32, 32]
    print("total_flops: ", cal_model_flops(model,input))
...
def train(trainloader, model, criterion, optimizer, epoch, use_cuda):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        bar.next()
    bar.finish()
    print('prec1: ', top1.avg, ' prec5: ', top5.avg)
